...
interface Props {
  ...
  email: string;
  open?: boolean;          // 手機抽屜開啟狀態（桌機忽略）
  onClose?: () => void;    // 手機：導覽後收合抽屜
...
export function ChatSidebar({ conversations, activeId, email, open, onClose, onSelect, onNew, onDelete, onLogout }: Props) {
  return (
    <>
